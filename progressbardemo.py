...
def demo_one_line_progress_meter():
    ...
    for i in range(10000):
        if not sg.OneLineProgressMeter('My 1-line progress meter', i + 1, 10000, 'meter key', 'MY MESSAGE1',
                'MY MESSAGE 2', orientation='h', bar_color=('white', 'red')):
            print('Hit the break')
            break
    for i in range(10000):
        if not sg.OneLineProgressMeter('My 1-line progress meter', i + 1, 10000, 'meter key', 'MY MESSAGE1',
                'MY MESSAGE 2', orientation='v'):
            print('Hit the break')
            break
    ...
    layout = [
            ...
            [sg.T('Outer Loop Count', size=(15, 1), justification='r'),
             sg.In(default_text='100', size=(5, 1), key='CountOuter', do_not_clear=True),
            ...
            [sg.T('Inner Loop Count', size=(15, 1), justification='r'),
             sg.In(default_text='100', size=(5, 1), key='CountInner', do_not_clear=True),
